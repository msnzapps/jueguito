...
var app = {
	...
	explodeStep: function() {
		...
		for(var i=0; i<this.sizeY; i++) for(var j=0; j<this.sizeX; j++) {
			...
			if (!it.flag) 
				continue;
			it.style.backgroundColor = document.body.style.backgroundColor;
	...
	fallStep: function() {
		...
		if(!this.step) {
			...
			for(var i=this.sizeY-1; i>0; i--) for(var j=0; j<this.sizeX; j++) {
				...
				if (shiftItem.flag) {
					shiftItem.flag=0;
					currItem.style.backgroundColor = shiftItem.style.backgroundColor;
					shiftItem.style.backgroundColor = document.body.style.backgroundColor;
